...
recent_modifications_query = ('SELECT DISTINCT Applications.application FROM Applications INNER JOIN ApplicationsJoin ON Applications.id = ApplicationsJoin.applicationId INNER JOIN Structures ON Structures.id = ApplicationsJoin.structureId ORDER BY Structures.uploadDate DESC LIMIT %s')
recent_keywords_query = ('SELECT DISTINCT Applications.application FROM Applications INNER JOIN ApplicationsJoin ON Applications.id = ApplicationsJoin.applicationId INNER JOIN Structures ON Structures.id = ApplicationsJoin.structureId ORDER BY Structures.uploadDate DESC LIMIT %s')
recent_authors_query = ('SELECT DISTINCT Applications.application FROM Applications INNER JOIN ApplicationsJoin ON Applications.id = ApplicationsJoin.applicationId INNER JOIN Structures ON Structures.id = ApplicationsJoin.structureId ORDER BY Structures.uploadDate DESC LIMIT %s')
